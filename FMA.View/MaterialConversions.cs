   ...
   public static class MaterialConversions
    {
       ...
       {
           return new CustomMaterial(material.Id, material.Title, material.Description, material.MaterialFields.Select(f => f.ToMaterialField()), material.FlyerFrontSide, material.FlyerBackside, material.LogoModel.Logo, material.LogoModel.LeftMargin, material.LogoModel.TopMargin, material.LogoModel.Size.Width, material.LogoModel.Size.Height);
       }   
