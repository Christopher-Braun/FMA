    ...
    public class DummyData
    {
        public static List<Material> GetDummyMaterials()
        {
            ...
            var material1Fields = new List<MaterialField>
            {
                ...
                new MaterialField("Referent", "Arial", 12, false, false, false, 80, 4, 24, 600, "Freie evangelische Gemeinde Hanau\rWeimarer Straﬂe 35\r63454 Hanau-Weststadt "),
            };
            ...
            var material2 = new Material(2, "Nordkorea", "Zum Thema NordkoreaÖ", material2Fields, Helper.GetBackground(2), Helper.GetBackground(2, false), "Bakery");
        ...
        public static CustomMaterial GetCustomMaterial()
        {
            ...
            return new CustomMaterial(2, "Nordkorea", "Zum Thema NordkoreaÖ", material2Fields, Helper.GetBackground(2), Helper.GetBackground(2, false), new CustomLogo());
        }
